...
class PresetsControllerTest < ActionController::TestCase
  ...
  test "should create preset" do
    assert_difference('Preset.count') do
      post :create, preset: { brightness: @preset.brightness, hue: @preset.hue, saturtion: @preset.saturtion }
    end
  ...
  test "should update preset" do
    patch :update, id: @preset, preset: { brightness: @preset.brightness, hue: @preset.hue, saturtion: @preset.saturtion }
    assert_redirected_to preset_path(assigns(:preset))
  end
